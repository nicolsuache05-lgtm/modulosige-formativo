...
<head>
    ...
    <title>@yield('title', 'Administración') - SENA Empresa ERP</title>
    ...
    <header class="admin-navbar sticky-top">
        <div class="container d-flex flex-wrap align-items-center justify-content-between gap-3">
            ...
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('admin.welcome') }}" class="text-white text-decoration-none d-flex align-items-center gap-2">
                    ...
                    <div>
                        ...
                        <small class="text-white-50 fs-8">Soporte y Seguridad • <strong style="color: var(--admin-cyan);">Administración</strong></small>
                    </div>
                </a>
            </div>
            ...
            <div class="d-none d-lg-flex align-items-center gap-1">
                <a href="{{ route('admin.welcome') }}" class="nav-link-custom {{ Route::is('admin.welcome') ? 'active' : '' }}">
                    <i class="fas fa-home"></i> Inicio
                </a>
                <a href="{{ route('admin.dashboard') }}" class="nav-link-custom {{ Route::is('admin.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-chart-pie"></i> Dashboard
                </a>
                <a href="{{ route('admin.usuarios.index') }}" class="nav-link-custom {{ Route::is('admin.usuarios.*') ? 'active' : '' }}">
                    <i class="fas fa-users-cog"></i> Usuarios
                </a>
                <a href="{{ route('admin.roles.index') }}" class="nav-link-custom {{ Route::is('admin.roles.*') ? 'active' : '' }}">
                    <i class="fas fa-user-shield"></i> Roles
                </a>
                <a href="{{ route('admin.permisos.index') }}" class="nav-link-custom {{ Route::is('admin.permisos.*') ? 'active' : '' }}">
                    <i class="fas fa-key"></i> Permisos
                </a>
                <a href="{{ route('admin.auditoria.index') }}" class="nav-link-custom {{ Route::is('admin.auditoria.*') ? 'active' : '' }}">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{ route('admin.usuarios.create') }}" class="btn btn-sm btn-admin">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-sm btn-dark bg-opacity-50 border border-secondary border-opacity-50 text-white rounded-pill px-2 py-1 d-flex align-items-center gap-2 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="text-start d-none d-md-block pe-1">
                                ...
                                <span class="badge bg-info text-dark fs-8 p-1" style="font-size: 10px !important;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 p-2 mt-2" style="min-width: 240px;">
                            <li class="p-2 border-bottom">
                                ...
                                <div class="mt-1">
                                    <span class="badge bg-primary bg-opacity-15 text-primary border border-primary border-opacity-25 rounded-pill px-2 py-1 fs-8">
                                        <i class="fas fa-user-shield me-1"></i> {{ Auth::user()->primary_role }}
                                    </span>
                                </div>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 rounded-3 text-dark fw-semibold d-flex align-items-center gap-2 mt-1" href="{{ route('admin.welcome') }}">
                                    <i class="fas fa-home text-info fs-6"></i>
                                    <span>Página Welcome Admin</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 rounded-3 text-dark fw-semibold d-flex align-items-center gap-2" href="{{ route('admin.dashboard') }}">
                                    <i class="fas fa-chart-line text-primary fs-6"></i>
                                    <span>Dashboard Administrativo</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 rounded-3 text-dark fw-semibold d-flex align-items-center gap-2" href="{{ route('admin.usuarios.index') }}">
                                    <i class="fas fa-users-cog text-success fs-6"></i>
                                    <span>Control de Usuarios</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 rounded-3 text-dark fw-semibold d-flex align-items-center gap-2" href="{{ route('admin.roles.index') }}">
                                    <i class="fas fa-user-shield text-warning fs-6"></i>
                                    <span>Control de Roles</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 rounded-3 text-dark fw-semibold d-flex align-items-center gap-2" href="{{ route('admin.auditoria.index') }}">
                                    <i class="fas fa-history text-danger fs-6"></i>
                                    <span>Registros de Auditoría</span>
                                </a>
                            </li>
                            <li><hr class="dropdown-divider my-1"></li>
                            <li>
                                <a class="dropdown-item py-2 rounded-3 text-danger fw-semibold d-flex align-items-center gap-2" href="{{ route('logout', ['redirect' => route('admin.welcome')]) }}">
        ...
        <div class="container">
            ...
            @if(session('info'))
                <div class="alert alert-info alert-dismissible fade show rounded-4 border-0 shadow-sm d-flex align-items-center gap-2 mb-4" role="alert">
                    ...
                    <div><strong>Información:</strong> {{ session('info') }}</div>
                    <button type="button" class="btn-close ms-auto" data-bs-dismiss="alert" aria-label="Cerrar"></button>
                </div>
            @endif
        ...
        <div class="container text-center">
            <div class="row align-items-center gy-2">
                ...
                <div class="col-md-6 text-md-end">
                    <span>Módulo de Administración y Seguridad • Desarrollado con Laravel</span>
                </div>
            </div>
        </div>
    </footer>
